...
def test_temperature_reduction():
    ...
    T_reduced_true = 2.17
    T_SI = 273 * u.kelvin
    T_reduced = unit_conversions.reduced_from_kelvin(T_SI, ref_energy)
    print(T_reduced)
...
def test_temperature_to_SI_conversion():
    ...
    T_reduced = 1
    T_SI = unit_conversions.kelvin_from_reduced(T_reduced, ref_energy)
    print(T_SI)
...
def test_dt_to_SI_conversion():
    ...
    dt_reduced = 0.001
    dt = unit_conversions.convert_to_real_time(
